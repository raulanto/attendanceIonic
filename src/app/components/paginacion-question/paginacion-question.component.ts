...
@Component({
  selector: 'app-paginacion-question',
  templateUrl: './paginacion-question.component.html',
  styleUrls: ['./paginacion-question.component.scss'],
})

export class PaginacionQuestionComponent implements OnInit {
